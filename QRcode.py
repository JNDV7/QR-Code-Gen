...
app.iconbitmap("C:/Users/Heiden/Documents/code/python/QRcode/icon.ico")

C = tkinter.Canvas(app, background="blue", height=250, width=300)
filename = tkinter.PhotoImage(file="C:/Users/Heiden/Documents/code/python/QRcode/image_fond.gif")
